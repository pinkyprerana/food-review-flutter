...
abstract class _PostFeedState extends PostFeedState {
  const factory _PostFeedState(
      ...
      final int currentPageAllPosts,
      final int totalPagesAllPosts,
      final List<SwipeItem> swipeItems}) = _$PostFeedStateImpl;
