...
import '../../your_lists/presentation/widgets/custom_widgets.dart';

@RoutePage()
class YourPeoplePage extends ConsumerStatefulWidget {
  const YourPeoplePage({super.key});

  @override
  ConsumerState<YourPeoplePage> createState() => _YourPeoplePageState();
}

class _YourPeoplePageState extends ConsumerState<YourPeoplePage> {
