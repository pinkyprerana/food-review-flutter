...
class _$LandingStateImpl extends _LandingState {
  const _$LandingStateImpl({this.isLoading = false}) : super._();
  ...
  @override
  String toString() {
    return 'LandingState(isLoading: $isLoading)';
  }
...
abstract class _LandingState extends LandingState {
  const factory _LandingState({final bool isLoading}) = _$LandingStateImpl;
