...
abstract class $BaseStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, int bottomNavIndex, int lastBottomNavIndex});
}
...
class _$BaseStateCopyWithImpl<$Res, $Val extends BaseState>
  ...
  $Res call({
    ...
    Object? lastBottomNavIndex = null,
  }) {
    return _then(_value.copyWith(
      ...
      bottomNavIndex: null == bottomNavIndex
          ...
          : bottomNavIndex // ignore: cast_nullable_to_non_nullable
              as int,
      lastBottomNavIndex: null == lastBottomNavIndex
          ? _value.lastBottomNavIndex
          : lastBottomNavIndex // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.lastBottomNavIndex, lastBottomNavIndex) ||
                other.lastBottomNavIndex == lastBottomNavIndex));
  }
...
abstract class _BaseState extends BaseState {
  const factory _BaseState(
      {final bool isLoading,
      final int bottomNavIndex,
      final int lastBottomNavIndex}) = _$BaseStateImpl;
