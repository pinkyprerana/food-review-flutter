...
@RoutePage()
class NewPhotoClickPage extends ConsumerStatefulWidget {
  const NewPhotoClickPage({super.key});

  @override
  ConsumerState<NewPhotoClickPage> createState() => _NewPhotoClickPageState();
}

class _NewPhotoClickPageState extends ConsumerState<NewPhotoClickPage> {
